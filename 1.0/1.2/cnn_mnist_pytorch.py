...
if is_train:
    ...
    torch.save(net.state_dict(),r'.\modelpara.pth')

# 加载模型参数
if use_gpu:
    net.load_state_dict(torch.load(r'.\modelpara.pth'))
else:
    net.load_state_dict(torch.load(r'.\modelpara.pth', map_location='cpu'))
